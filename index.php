<?php
    ...
    <section class = "pricing" style="margin-top:50px; padding:8%;background: #1D5390">
      ...
      <div class = "row">
          <div class = "col" >
          <span style="color:#fff;font-size:8rem;font-weight:700;display:block;padding:0;"><span style="margin:0;font-size:6rem; font-weight:600;padding:0;position:relative;left:20px;">$</span>  19</span>
